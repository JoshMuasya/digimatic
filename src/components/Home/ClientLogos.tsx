...
const clients = [
    { name: "Nyiha-Mathenge Advocates", abbr: "NMA" },
    { name: "NEFEA", abbr: "NEFEA" },
    { name: "Twilight Luxe Creations", abbr: "TLC" },
    { name: "Wilhide Bakers", abbr: "WB" },
    { name: "Gatherly", abbr: "GTH" },
    { name: "Kirie Scripts", abbr: "KS" },
]
...
const ClientLogos = () => {
    return (
        <section className="py-14 border-y border-border bg-card/30 backdrop-blur-sm overflow-hidden">
            <motion.div
            ...
            >
                {[
                    { number: 500, suffix: "+", label: "Deliverables Completed" },
