        ...
        <section className="relative min-h-screen bg-background w-full overflow-hidden flex items-center justify-center pt-20">
            ...
            >
                <motion.div variants={itemVariants} className="space-y-6">
                    ...
                    >
                        We are a forward-thinking technology company dedicated to delivering cutting-edge digital solutions that transform businesses and drive innovation.
                    </motion.p>
                </motion.div>
            </motion.div>
        </section>
